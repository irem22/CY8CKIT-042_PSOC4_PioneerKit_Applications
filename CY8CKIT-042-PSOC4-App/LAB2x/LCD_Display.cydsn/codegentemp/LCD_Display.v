...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("ee17301b-85c3-45f0-9fe9-9dfa48841592/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__Pin_K_net;
	wire [0:0] tmpFB_0__Pin_K_net;
	wire [0:0] tmpIO_0__Pin_K_net;
	wire [0:0] tmpINTERRUPT_0__Pin_K_net;
	electrical [0:0] tmpSIOVREF__Pin_K_net;

	cy_psoc3_pins_v1_10
		#(.id("2e7fca42-ca1e-4169-ba1d-6d9d3cb7f7b9"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		Pin_K
		 (.oe(tmpOE__Pin_K_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_K_net[0:0]}),
		  .io({tmpIO_0__Pin_K_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_K_net),
		  .interrupt({tmpINTERRUPT_0__Pin_K_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_K_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
