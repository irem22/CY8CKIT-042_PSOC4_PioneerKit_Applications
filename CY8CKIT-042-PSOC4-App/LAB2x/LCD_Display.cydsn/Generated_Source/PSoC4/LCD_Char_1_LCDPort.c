...
#include "LCD_Char_1_LCDPort.h"
    ...
    #define LCD_Char_1_LCDPort_SetP4PinDriveMode(shift, mode)  \
    do { \
        LCD_Char_1_LCDPort_PC =   (LCD_Char_1_LCDPort_PC & \
                                (uint32)(~(uint32)(LCD_Char_1_LCDPort_DRIVE_MODE_IND_MASK << \
                                (LCD_Char_1_LCDPort_DRIVE_MODE_BITS * (shift))))) | \
                                (uint32)((uint32)(mode) << \
                                (LCD_Char_1_LCDPort_DRIVE_MODE_BITS * (shift))); \
    } while (0)
#else
        ...
        #define LCD_Char_1_LCDPort_SetP4PinDriveMode(shift, mode)  \
        do { \
            LCD_Char_1_LCDPort_USBIO_CTRL_REG = (LCD_Char_1_LCDPort_USBIO_CTRL_REG & \
                                    (uint32)(~(uint32)(LCD_Char_1_LCDPort_DRIVE_MODE_IND_MASK << \
                                    (LCD_Char_1_LCDPort_DRIVE_MODE_BITS * (shift))))) | \
                                    (uint32)((uint32)(mode) << \
                                    (LCD_Char_1_LCDPort_DRIVE_MODE_BITS * (shift))); \
    ...
    *******************************************************************************/
    ...
    {
		LCD_Char_1_LCDPort_SetP4PinDriveMode(LCD_Char_1_LCDPort__0__SHIFT, mode);
		LCD_Char_1_LCDPort_SetP4PinDriveMode(LCD_Char_1_LCDPort__1__SHIFT, mode);
		LCD_Char_1_LCDPort_SetP4PinDriveMode(LCD_Char_1_LCDPort__2__SHIFT, mode);
		LCD_Char_1_LCDPort_SetP4PinDriveMode(LCD_Char_1_LCDPort__3__SHIFT, mode);
		LCD_Char_1_LCDPort_SetP4PinDriveMode(LCD_Char_1_LCDPort__4__SHIFT, mode);
		LCD_Char_1_LCDPort_SetP4PinDriveMode(LCD_Char_1_LCDPort__5__SHIFT, mode);
		LCD_Char_1_LCDPort_SetP4PinDriveMode(LCD_Char_1_LCDPort__6__SHIFT, mode);
    }
#endif
...
void LCD_Char_1_LCDPort_SetInterruptMode(uint16 position, uint16 mode)
{
    ...
    intrCfg =  LCD_Char_1_LCDPort_INTCFG & (uint32)(~(uint32)position);
    LCD_Char_1_LCDPort_INTCFG = intrCfg | ((uint32)position & (uint32)mode);
}
